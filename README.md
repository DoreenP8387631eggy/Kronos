...
> **Personal note:** I'm studying this repo to understand how the hierarchical tokenizer handles OHLCV normalization across different exchanges with varying price scales. The two-stage approach is particularly interesting for crypto markets.
